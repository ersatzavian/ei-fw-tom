...
const IMAGE_URL = "http://demo.electricimp.com/hackathon/lcd/impLOL.bmp";

// Split image into this many chunks before sending 
// *must* be at least 2, but 4 or more is better
// If you want the image to display smoothly, adding some memory (e.g. SPI flash) is necessary
const NUM_PARTS = 4;
