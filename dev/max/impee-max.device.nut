...
//
// A- CS (not sure if it's active high/low)
// 2- MISO
// 5- SCLK
// 7- MOSI
// B- RESET (also not sure about active high/low)
// C- Interrupt (not sure if this is useful for anything)
//
...
//
// Some vaguely useful source code
...
vbus_en <- hardware.pinD;
vbus_en.configure(DIGITAL_OUT,1);
...
// Test General Purpose LEDs
hardware.pin8.configure(PWM_OUT, 1.0, 0.5);
hardware.pin9.configure(PWM_OUT, 1.5, 0.5);
